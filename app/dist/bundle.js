...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Pane = __webpack_require__(90);
	...
	var App = function (_Component) {
	    ...
	    function App() {
	        ...
	        _electron.ipcRenderer.on('message_received', _this2._onMessageReceived);
	        return _this2;
	    }
	    ...
	    _createClass(App, [{
	        ...
	        value: function componentWillMount() {
	            var addresses = _electron.ipcRenderer.sendSync('get-available-addresses');
	            if (addresses) {
	            ...
	            var response = _electron.ipcRenderer.sendSync('get-server-conf');
	            if (response) {
	        ...
	        key: '_handleStartServerClient',
	        value: function _handleStartServerClient(e) {
	            e.preventDefault();
	            ...
	            var response = _electron.ipcRenderer.sendSync('start-server-client-udp', {
	        ...
	        key: '_handleStopServerClient',
	        value: function _handleStopServerClient(e) {
	            e.preventDefault();
	            var response = _electron.ipcRenderer.sendSync('stop-server-client-udp');
	        ...
	        value: function _handleSendMessage(err, e) {
	            e.preventDefault();
	            ...
	            var response;
	            if (err) {
	                response = _electron.ipcRenderer.sendSync('send-data', {
	        ...
	        key: '_handleSendErrorMessage',
	        value: function _handleSendErrorMessage(e) {
	            e.preventDefault();
	        }
	    }, {
	        key: 'readFile',
	        ...
	        value: function _onMessageReceived(event, args) {
	            var new_received_messages = [].concat(_toConsumableArray(_this.state.received_messages), [{ id: args.id, message: args.message, data: args.data, address: args.address, port: args.port }]);
	        ...
	        key: '_saveAttachedFile',
	        value: function _saveAttachedFile(messageID) {
	            var response = _electron.ipcRenderer.sendSync('save-file', messageID);
	            alert(response.type + ": " + response.message);
	        }
	    }, {
	        key: '_showMessageDetails',
	        value: function _showMessageDetails(messageID) {
	            var response = _electron.ipcRenderer.sendSync('get-message-details', messageID);
	        ...
	        value: function render() {
	            ...
	            if (this.state.available_addresses) {
	                availableAddresses = this.state.available_addresses.map(function (address, i) {
	            ...
	            var button = _react2.default.createElement('input', { type: 'button', name: 'start_server_client_button', className: 'btn btn-form btn-positive', value: 'Start Server', onClick: this._handleStartServerClient.bind(this) });
	            if (this.state.config_message != null && this.state.config_message != "") {
	                if (this.state.config_message.startsWith("ERROR")) {
	                    infoMessage = _react2.default.createElement(
	                        'div',
	                        { id: 'server_client_message', className: 'btn-negative' },
	                        this.state.config_message
	                    );
	                } else {
	                    infoMessage = _react2.default.createElement(
	                        'div',
	                        { id: 'server_client_message', className: 'btn-positive' },
	                        this.state.config_message
	                    );
	                    button = _react2.default.createElement('input', { type: 'button', name: 'stop_server_client_button', className: 'btn btn-form btn-negative', value: 'Stop Server', onClick: this._handleStopServerClient.bind(this) });
	                }
	            } else {
	                infoMessage = null;
	            }
	            ...
	            if (this.state.received_messages.length > 0) {
	                receivedMessages = this.state.received_messages.map(function (message, i) {
	                    var dataInfo, messageContent;
	                    if (message.data != null && message.data != {}) {
	                        dataInfo = _react2.default.createElement(
	                            'div',
	                            null,
	                            ...
	                            _react2.default.createElement(
	                                'button',
	                                { className: 'btn btn-mini btn-default', onClick: _this3._saveAttachedFile.bind(_this3, message.id) },
	                                'Save file'
	                            )
	                        );
	                    } else {
	                    ...
	                    return _react2.default.createElement(
	                        'li',
	                        { className: 'list-group-item', key: message.id },
	                        _react2.default.createElement(
	                            'div',
	                            ...
	                            _react2.default.createElement(
	                                'button',
	                                { className: 'btn btn-mini btn-default', onClick: _this3._showMessageDetails.bind(_this3, message.id) },
	                                'Show details'
	                            )
	                        )
	                    );
	                ...
	                receivedMessages = _react2.default.createElement(
	                    'strong',
	                    null,
	            ...
	            if (this.state.displayed_message_details) {
	                messageDetails = this.state.displayed_message_details.map(function (detail, i) {
	                    var correctCRC32 = detail.crc32 ? "Correct" : "Incorrect";
	                    var multipleReceived = detail.receivedMultiple ? "Yes" : "No";
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            _Pane2.default,
	                            { label: 'Configuration', icon: 'icon icon-cog' },
	                            _react2.default.createElement(
	                                'form',
	                                { id: 'config_form' },
	                                infoMessage,
	                                _react2.default.createElement(
	                                    ...
	                                    _react2.default.createElement(
	                                        'select',
	                                        { name: 'config_ip', className: 'form-control', value: this.state.config_ip, onChange: this._handleFormChange.bind(this) },
	                                        availableAddresses
	                                    )
	                                ),
	                                _react2.default.createElement(
	                                    ...
	                                    _react2.default.createElement('input', { name: 'config_port', type: 'number', min: '49152', max: '65535', className: 'form-control', placeholder: 'Server Port', value: this.state.config_port, onChange: this._handleFormChange.bind(this) })
	                                ),
	                                _react2.default.createElement(
	                                    'div',
	                        ...
	                        _react2.default.createElement(
	                            _Pane2.default,
	                            { label: 'Send message', icon: 'icon icon-cog', disabled: configDone },
	                            _react2.default.createElement(
	                                'form',
	                                ...
	                                _react2.default.createElement(
	                                    ...
	                                    _react2.default.createElement('input', _defineProperty({ name: 'destination_ip', type: 'text', required: true, pattern: '((^|\\.)((25[0-5])|(2[0-4]\\d)|(1\\d\\d)|([1-9]?\\d))){4}$', className: 'form-control', placeholder: 'Destination IP', value: this.state.destination_ip, onChange: this._handleFormChange.bind(this) }, 'required', true))
	                                ),
	                                _react2.default.createElement(
	                                    'div',
	                                    { className: 'form-group' },
	                                    ...
	                                    _react2.default.createElement('input', { name: 'destination_port', type: 'number', min: '49152', max: '65535', className: 'form-control', placeholder: 'Destination Port', value: this.state.destination_port, onChange: this._handleFormChange.bind(this), required: true })
	                                ),
	                                _react2.default.createElement(
	                                    'div',
	                                    { className: 'form-group' },
	                                    ...
	                                    _react2.default.createElement('input', { name: 'destination_fragment_size', type: 'number', min: '1', max: '65535', className: 'form-control', placeholder: 'Maximum size of fragment', value: this.state.destination_fragment_size, onChange: this._handleFormChange.bind(this) })
	                                ),
	                                _react2.default.createElement(
	                                    'div',
	                                    { className: 'form-group' },
	                                    ...
	                                    _react2.default.createElement('textarea', { name: 'destination_message', className: 'form-control', rows: '3', placeholder: 'Type in message, you want to send...', value: this.state.destination_message, onChange: this._handleFormChange.bind(this) })
	                                ),
	                                _react2.default.createElement(
	                                    'div',
	                                    { className: 'form-group' },
	                                    ...
	                                    _react2.default.createElement('input', { type: 'file', className: 'form-control', id: 'destination_files', rows: '3', multiple: false, onChange: this.readFile.bind(this) })
	                                ),
	                                _react2.default.createElement(
	                                    'div',
	                                    { className: 'form-actions' },
	                                    _react2.default.createElement('input', { name: 'send_error_data_button', type: 'submit', className: 'btn btn-form btn-negative', onClick: this._handleSendMessage.bind(this, true), value: 'Send error frame' }),
	                                    _react2.default.createElement('input', { name: 'send_data_button', type: 'submit', className: 'btn btn-form btn-positive', onClick: this._handleSendMessage.bind(this, false), value: 'Send message' })
	                                )
	                            )
	                        ),
	                        _react2.default.createElement(
	                            _Pane2.default,
	                            { label: 'Received Messages', icon: 'icon icon-cog', disabled: configDone },
	                            _react2.default.createElement(
	                                'div',
	    ...
	    _createClass(Tabs, [{
	        ...
	        value: function _renderTitles() {
	            function labels(child, index) {
	                var isEnabled = this.handleClick.bind(this, index);
	                if (child.props.disabled) isEnabled = null;
	                var activeClass = this.state.selected === index ? 'nav-group-item active' : 'nav-group-item';
	                return _react2.default.createElement(
	                    'span',
	                    { key: index, className: activeClass, onClick: isEnabled },
	                    _react2.default.createElement('span', { className: child.props.icon }),
	                    _react2.default.createElement(
	                        'span',
	                        null,
	                        child.props.label
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, "?path=http://localhost:4000/__webpack_hmr&reload=true", __webpack_require__(172)(module)))
